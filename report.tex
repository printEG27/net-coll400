...
proceed to feature engineering. The raw data cannot be directly used for training, thus we extract eight key features from each record:\\\\
...
model: Linear Regression (Fig 4), Logistic Regression (Fig 5),
and Random Forest (Fig 6).
