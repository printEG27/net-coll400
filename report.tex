...
\begin{figure}
    ...
    \caption{The interface of Wireshark, demonstrating
its comprehensive design.}
    \label{fig:2}
\end{figure}
...
proceed to feature engineering. The raw data cannot be directly used for training, thus we extract nine key features from each record, focusing on the dimensions of \textbf{Time and
