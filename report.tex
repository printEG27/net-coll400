...
achieves the highest accuracy (\textbf{X}) and Macro F1 score
(\textbf{X}), outperforming both Linear and Logistic Regression
...
Forest outperformed both Linear and Logistic Regression in terms of both Accuracy and Macro F1 score. Specifically, Random Forest achieved an accuracy of \textbf{X} and a Macro F1 score of \textbf{x}, compared to Logistic Regression’s accuracy of \textbf{X}
and Macro F1 score of \textbf{X}. This performance gap highlights
